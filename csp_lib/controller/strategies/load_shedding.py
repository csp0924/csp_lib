            ...
            for stage_name, action in actions:
                ...
                for circuit in stage.circuits:
                    try:
                        ...
                        logger.exception(f"Failed to {action} circuit '{circuit.name}' (stage: {stage_name})")
        ...
        for stage in reversed(self._sorted_stages):
            ...
            for circuit in stage.circuits:
                try:
                    ...
                    logger.exception(f"Failed to auto-restore circuit '{circuit.name}' (stage: {stage.name})")
