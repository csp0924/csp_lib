...
csp_lib v0.4.0 系統圖表集，以 Mermaid 語法呈現系統總覽、核心流程、狀態機與設備生命週期。

---

## 1. 系統總覽架構圖

v0.4.0 完整 8 層架構。依賴方向由下往上；CAN（Layer 2b）與 Modbus（Layer 2a）並列於 Layer 2。
...
| `CircuitBreaker` | 通用斷路器（Core 層，v0.4.0 移入） | [[_MOC Core]] |
