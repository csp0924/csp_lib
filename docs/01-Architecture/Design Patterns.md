...
| `DeviceProtocol` | `csp_lib.equipment.device` | 通用設備介面（v0.4.0） |
| `EventDrivenOverride` | `csp_lib.controller.system` | 事件驅動覆蓋協定（v0.4.0） |
| `LoadCircuitProtocol` | `csp_lib.controller.strategies` | 負載迴路控制（v0.4.0） |
